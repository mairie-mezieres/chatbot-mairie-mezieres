...
/* Prix et dates d'un enregistrement.
   ...
   `maj` / `majISO` au niveau de la station restent exposés (le bandeau
   d'accueil n'a qu'une ligne pour les deux prix), mais ils valent désormais le
   **plus ancien** des relevés affichés : ainsi la date annoncée est vraie pour
   TOUS les prix montrés. L'inverse — le plus récent — ferait passer un prix
