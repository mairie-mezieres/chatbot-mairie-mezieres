...
const DIRECT_RULES = [
  ...
  // « nouvel_habitant » en dernier pour ne rien avaler au passage.
  {
    ...
    answer: "📮 Changement d'adresse : le téléservice unique « Je change de coordonnées » sur service-public.gouv.fr prévient en une seule fois l'assurance maladie, les caisses de retraite, les impôts, France Travail et la CAF. À faire en plus : votre employeur, votre banque et vos assurances, la réexpédition du courrier auprès de La Poste, la mise à jour de votre carte grise dans le mois qui suit (obligatoire, sur ants.gouv.fr) et votre inscription sur les listes électorales de Mézières-lez-Cléry. La mairie (02 38 45 61 76) reste à votre disposition."
  },
  {
  ...
  },
  {
    ...
    answer: "📦 Bienvenue à Mézières-lez-Cléry ! Les démarches à prévoir en arrivant : 1) passer vous présenter en mairie — 02 38 45 61 76, lundi 14h-17h30, mercredi sur rendez-vous, vendredi 8h30-11h30 ; 2) déclarer votre changement d'adresse via le téléservice de service-public.gouv.fr ; 3) faire mettre en service vos compteurs d'eau, d'électricité et de gaz ; 4) demander vos bacs gris et jaune et vous inscrire à la déchetterie sur portail-usagers.ccterresduvaldeloire.fr ; 5) vous inscrire sur les listes électorales ; 6) inscrire vos enfants à l'école de la Forêt, au restaurant scolaire et au périscolaire ; 7) vérifier votre éligibilité à la fibre sur valdeloire-fibre.fr. L'application Mézières Avec Toi reprend cette liste complète et cochable dans sa page « Je viens d'emménager »."
  },
  {
    name: "cantine",
