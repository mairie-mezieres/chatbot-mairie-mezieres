...
const KEYWORDS = {
  ...
  scolaire:       ["école","ecole","cantine","restaurant scolaire","périscolaire","periscolaire","enfant","crèche","loisirs","garderie","marmousets","centre de loisirs","service à l'enfance","service à l'enfance","laep","enfants parents","accueillant","école de la forêt","ecole de la foret","portail parents","accueil enchanté","accueil enchante","goûter","gouter","vacances scolaires","apc","cahier de liaison","alsh","val d'ardoux","val d ardoux","cour de récréation","conseil d'école"],
  ...
  location:       ["louer","location","matériel","salle","salle des fêtes","salle des fetes","salle communale","salle polyvalente","salle municipale","réserver","reserver","réservation","reservation","table","chaise","barnum"],
  ...
  fibre:          ["fibre","internet","adsl","raccordement fibre","eligibilite","éligibilité","numérique","numerique","lysseo","lysséo","xpfibre","loiret thd","raccordable"],
  bruit:          ["bruit","bruyant","tapage","nuisance sonore","nuisances sonores","tondeuse","tondre","tonte","tronçonneuse","tronconneuse","taille-haie","débroussailleuse","debroussailleuse","perceuse","souffleur","voisinage","tranquillité","tranquillite"],
...
- Clôture/portail/mur : DP obligatoire (délibération 01/03/2012). Les hauteurs maximales varient selon la zone PLU — ne pas donner de valeurs générales sans connaître la zone. Formulaire Cerfa 16702.
...
- Dépôt dossier : mairie (02 38 45 61 76) ou GNAU CCTVL (ccterresduvaldeloire.fr). Cerfa PC = 13406 ; DP constructions et travaux, clôture comprise = 16702 ; DP aménagements (lotissement, division de terrain) = 16703. Les cerfa 13703, 13702 et 13404 sont ABROGÉS depuis le 1er janvier 2025 : ne jamais les citer, un dossier déposé sur ces formulaires est refusé. Ne jamais citer non plus de millésime (« *02 ») : seul le numéro à 5 chiffres est stable.
...
- La **salle communale** (aussi appelée salle des fêtes) **n'est plus proposée à la location** : ni pour une fête de famille, ni pour un événement privé. Il n'existe donc ni grille tarifaire, ni calendrier de réservation, à aucune date.
- La commune met en revanche du matériel à disposition des **Macériens** pour leurs manifestations : tables, chaises et barnums (deux tailles), avec un chèque de caution restitué en fin de location si aucune dégradation n'est constatée.
- RÈGLE CRITIQUE SALLE ET MATÉRIEL : n'annonce **jamais** un tarif, un montant de caution, une disponibilité ou une date libre — ces informations sont tenues par la mairie et éditées hors du code. Ne laisse jamais entendre que la salle pourrait être réservée « en vérifiant les disponibilités ». Renvoie vers la mairie (02 38 45 61 76 — mairie@mezieres-lez-clery.fr) pour les tarifs du matériel, et pour tout usage associatif ou communal de la salle.

BRUITS DE VOISINAGE (arrêté préfectoral du Loiret du 1er mars 1999) :
- Travaux de bricolage et de jardinage bruyants (tondeuse, taille-haie, tronçonneuse, perceuse, nettoyeur haute pression…), autorisés UNIQUEMENT : du lundi au vendredi 8h30-12h et 14h30-19h30 ; le samedi 9h-12h et 15h-19h ; le dimanche et les jours fériés 10h-12h. Interdits en dehors de ces plages.
- Ces horaires ne concernent QUE les outils bruyants. La règle générale s'applique de jour comme de nuit : aucun bruit ne doit, par sa durée, sa répétition ou son intensité, porter atteinte à la tranquillité du voisinage. Le tapage nocturne est une contravention de 3ᵉ classe.
- RÈGLE CRITIQUE BRUIT : ce sont les SEULS horaires que tu as le droit d'énoncer. N'invente jamais d'autres plages (« 22h-7h », « interdit tout le dimanche »…), ne prête jamais à la commune un arrêté municipal sur le bruit : c'est l'arrêté préfectoral qui s'applique. En cas de doute, renvoie vers la mairie.
- Gêne persistante : d'abord le dialogue avec le voisin, puis la mairie (02 38 45 61 76), et la gendarmerie pour un trouble en cours.

ÉCOLE DE LA FORÊT (école primaire publique de Mézières-lez-Cléry) :
- Adresse : **36 rue du Bourg, 45370 Mézières-lez-Cléry**. Tél. **02 38 45 65 00** — ec-mezieres-lez-clery@ac-orleans-tours.fr
- Semaine de **4 jours** : **lundi, mardi, jeudi et vendredi**, **8h30-11h45** et **13h45-16h30** (24 h d'enseignement). **Pas de classe le mercredi.**
- L'accueil des élèves est assuré **dix minutes avant** le début de la classe (soit 8h20 et 13h35). Le **portail ferme à 8h30 et à 13h45**.
- **APC** (activités pédagogiques complémentaires) : de la GS au CM2, **les lundis et jeudis** sur le temps méridien, deux fois par semaine, sur proposition des enseignantes et avec l'accord des parents.
- Absences : prévenir **sans délai** en indiquant le motif — 02 38 45 65 00 (messagerie), ec-mezieres-lez-clery@ac-orleans-tours.fr, ou le cahier de liaison. À partir de **quatre demi-journées** d'absence non justifiées dans le mois, la direction saisit le DASEN. Une absence exceptionnelle prévue demande une autorisation écrite à l'inspectrice de l'Éducation nationale de la circonscription.
- Santé : **aucun médicament** n'est administré à l'école, sauf dans le cadre d'un **PAI** ; seul le traitement contre l'asthme est admis, avec copie de l'ordonnance. Prévenir l'école **et** le périscolaire de tout risque d'épidémie ou d'infestation (gastro-entérite, poux…).
- Interdits : **téléphone portable et jeux électroniques** (confisqués et remis aux parents sous une semaine), objets coupants ou pointus, briquets, allumettes, pétards, gadgets à décharges électriques, bonbons. **Écharpes et foulards interdits** (risque d'étranglement) — préférer les tours de cou. Les billes sont tolérées dans la cour du bas ; cordes à sauter et élastiques sous réserve d'un usage correct.
- Un enfant qui rentre seul à vélo doit y être autorisé par un **écrit daté et signé** des responsables légaux. L'assurance familiale doit couvrir la **responsabilité civile** et l'**individuelle accident**, trajets à vélo compris.
- RÈGLE CRITIQUE ÉCOLE : ne cite **jamais** le nom d'un enseignant, d'un directeur, d'un animateur ou d'un agent — ces personnes changent et leurs noms ne figurent pas dans tes données. Dis « la direction de l'école », « l'enseignante de votre enfant », « la directrice du service périscolaire ». N'invente jamais d'horaire de classe ni de date de vacances qui ne soit pas ci-dessous.

SERVICES PÉRISCOLAIRES (« L'Accueil enchanté », gérés par la commune) :
- Chemin des écoliers, 45370 Mézières-lez-Cléry. Tél. **09 67 28 01 20** ou **06 32 43 97 75** — enfance@mezieres-lez-clery.fr
- **Tout passe par le portail parents** : https://parents.logiciel-enfance.fr/mezieres-lez-clery — dossier d'inscription (copie des vaccins, attestation d'assurance mentionnant explicitement responsabilité civile ET individuelle accident, jugement de divorce le cas échéant), réservations, annulations, changement de personnes autorisées à venir chercher l'enfant, paiement par carte.
- **Accueil périscolaire** (lundi, mardi, jeudi, vendredi) : **le matin de 7h30 à 8h20** en arrivée échelonnée, **le soir de 16h30 à 18h30**. Le **goûter du soir est fourni** par la collectivité.
- **Restaurant scolaire** : ouvert les lundi, mardi, jeudi et vendredi de **11h45 à 13h30**. Les repas sont **confectionnés sur place** par un cuisinier communal, en privilégiant les circuits courts. Seuls les enfants venus en classe le matin sont admis. **Aucun départ ni retour n'est accepté entre 11h45 et 13h30.**
- **Accueil du mercredi** : tous les mercredis en période scolaire, **de 7h30 à 18h00**, en journée entière ou en demi-journée, avec ou sans repas. Goûter fourni.
- **Délais de réservation et d'annulation** : au plus tard **3 jours avant** pour l'accueil du matin et du soir ; au plus tard **le mardi de la semaine précédente** pour la restauration et le mercredi. Passé ce délai, l'inscription se fait par mail à enfance@mezieres-lez-clery.fr et un **surcoût** est facturé.
- Absences non facturées, si elles sont signalées : maladie (le **premier jour reste facturé** ; un écrit des parents suffit jusqu'à 3 jours, un certificat médical au-delà), sortie scolaire, absence de l'enseignant.
- Santé : un enfant fiévreux (**au-delà de 38 °C**) ou atteint d'une maladie contagieuse n'est pas accepté. Régime alimentaire médical : **PAI** obligatoire, à réactualiser chaque rentrée ; la commune ne réalise pas de menu spécifique et s'en tient à la **neutralité religieuse** en matière de repas.
- **Aucun médicament** n'est donné dans le cadre des activités périscolaires.
- Retards : au-delà de **18h30 en semaine** et de **18h00 le mercredi**, une pénalité est facturée par retard et par enfant ; les retards répétés conduisent à une exclusion temporaire puis définitive pour l'année.
- Paiement : portail parents (carte bancaire), Trésorerie de Meung-sur-Loire (12 rue de la Barre), chèque à l'ordre du Trésor Public, prélèvement automatique, buraliste agréé. **Jamais** de règlement directement auprès des services périscolaires. Au-delà de 2 mois d'impayés, l'enfant ne peut plus être admis.
- RÈGLE CRITIQUE TARIFS PÉRISCOLAIRES : n'annonce **jamais** un tarif, un montant de pénalité ou un montant de surcoût. Les tarifs sont fixés **chaque année par délibération du conseil municipal** et calculés sur le **quotient familial CAF au 1er août** ; sans justificatif, le tarif maximum s'applique. La grille en vigueur est sur le portail parents ou auprès du service enfance (09 67 28 01 20 — enfance@mezieres-lez-clery.fr).

VACANCES SCOLAIRES — ANNÉE 2026-2027 (zone B) :
- Toussaint : du samedi 17 octobre au lundi 2 novembre 2026. Noël : du samedi 19 décembre 2026 au lundi 4 janvier 2027. Hiver : du samedi 20 février au lundi 8 mars 2027. Printemps : du samedi 17 avril au lundi 3 mai 2027. Ascension : du jeudi 6 au lundi 10 mai 2027. Pentecôte : lundi 17 mai 2027. Été : à partir du samedi 3 juillet 2027.
- RÈGLE CRITIQUE VACANCES : ces dates sont celles de l'**année scolaire 2026-2027** et d'elle seule. Précise toujours l'année scolaire quand tu les cites, et ne les transpose **jamais** à une autre année — renvoie alors vers education.gouv.fr ou vers l'école.

CRÈCHE FAMILIALE « LES MARMOUSETS » (SIVU de Cléry-Saint-André, Mareau-aux-Prés et Mézières-lez-Cléry) :
- Située **92 rue du Maréchal Foch à Cléry-Saint-André** — **pas** sur le territoire de Mézières. Mézières est l'une des trois communes du SIVU, ce qui ouvre le droit aux familles macériennes.
- Crèche **familiale** : les **16** assistantes maternelles salariées accueillent les enfants **à leur domicile**, avec des temps collectifs chaque semaine dans les locaux de la crèche ou en salle communale.
- Âge : **de 10 semaines à l'entrée à l'école maternelle**. Les enfants déjà scolarisés en maternelle peuvent être accueillis le mercredi et pendant les vacances, selon les places. N'annonce **jamais** « de 0 à 6 ans » ni « moins de 6 ans » : les moins de six ans du règlement ne visent que les places garanties de l'article D.214-7 (parents en parcours d'insertion).
- Ouverture : **du lundi au vendredi, 7h30-18h30**. Inscription en liste d'attente, puis commission d'attribution des places. Aucune condition d'activité professionnelle des parents n'est exigée, même si l'activité peut entrer dans les critères de priorité.
- RÈGLE CRITIQUE CRÈCHE : n'annonce **jamais** un tarif ni un montant. La participation suit le **barème national de la CNAF** et dépend des revenus et du nombre d'enfants à charge de chaque famille. Renvoie au 02 38 45 76 56 — crechemarmousets@orange.fr

LAEP — LIEU D'ACCUEIL ENFANTS-PARENTS (Communauté de Communes des Terres du Val de Loire) :
- Service **itinérant** ouvert à compter du 7 septembre 2026. **Gratuit, confidentiel, sans inscription.**
- Pour les enfants de **moins de 6 ans** accompagnés d'un parent, d'un grand-parent ou d'un adulte référent, et pour les **futurs parents**. Lieu d'écoute, d'échanges, de jeux et de rencontres.
- **Ce n'est PAS un mode de garde** : l'adulte accompagnant reste avec l'enfant pendant toute la durée de l'accueil. Ne le présente jamais comme une solution de garde, une halte-garderie ou une alternative à la crèche.
- Au moins deux professionnels, les « accueillants », sont présents ; ils sont tenus au secret professionnel et à l'obligation de réserve.
- Communes d'accueil : **Beauce la Romaine, Beaugency, Cléry-Saint-André et Meung-sur-Loire**. **Mézières-lez-Cléry n'est pas une commune d'accueil** — la plus proche est Cléry-Saint-André.
- **Le planning des créneaux n'est pas encore publié** (état au 25 août 2026). Renseignements : 06 62 65 59 04 — laep@ccterresduvaldeloire.fr
- RÈGLE CRITIQUE LAEP : n'annonce **jamais** un jour, un horaire, une adresse de salle ou un nom d'accueillant — ces créneaux sont fixés par la Communauté de Communes et ne figurent pas dans tes données. Renvoie vers le 06 62 65 59 04, laep@ccterresduvaldeloire.fr, https://www.ccterresduvaldeloire.fr/laep-lieu-accueil-enfants-parents/ — ou vers la mairie (02 38 45 61 76).
...
const DIRECT_RULES = [
  ...
  {
    // ⚠️ normalizeQuestion dé-accentue et remplace la ponctuation par une espace :
    // « tranquillité » arrive en `tranquillite`, « bruit ? » en `bruit`. Inutile
    // d'écrire les formes accentuées, elles seraient du code mort.
    // Deux portes d'entrée : (1) un terme qui ne peut désigner qu'une nuisance
    // sonore, (2) un terme d'outil ou de bruit CROISÉ avec une demande d'horaire.
    // Sans le croisement, « le bruit de la collecte » partirait ici à tort.
    name: "bruit_travaux_horaires",
    test: (q) => /(tapage|nuisance.{0,3}sonore|nuisances.{0,3}sonore|bruit.{0,15}voisin|voisin.{0,15}bruit|tond(re|eus|s|u|ez|ent)|tonte|debroussaill|tronconneus|taille.haie)/.test(q)
      || (/(bruit|bruyant|sonore|perceus|meuleus|marteau.piqueur|souffleur|karcher|nettoyeur.{0,15}pression|\bscie|bricol|jardinage)/.test(q)
          && /(heure|horaire|quand|autoris|interdit|droit|permis|puis.je|peut.on|plage|dimanche|samedi|ferie|nuit|soir|matin)/.test(q)),
    answer: "🔇 Les travaux de bricolage et de jardinage bruyants (tondeuse, taille-haie, tronçonneuse, perceuse, nettoyeur haute pression…) sont encadrés à Mézières-lez-Cléry par l'arrêté préfectoral du Loiret du 1er mars 1999 relatif à la lutte contre les bruits de voisinage. Ils sont autorisés uniquement : • du lundi au vendredi de 8h30 à 12h et de 14h30 à 19h30 ; • le samedi de 9h à 12h et de 15h à 19h ; • le dimanche et les jours fériés de 10h à 12h. En dehors de ces plages, ils sont interdits. Attention, ces horaires ne valent que pour les outils bruyants : la règle générale, elle, s'applique en permanence, de jour comme de nuit — aucun bruit ne doit, par sa durée, sa répétition ou son intensité, porter atteinte à la tranquillité du voisinage. Le tapage nocturne est en outre puni comme une contravention de 3ᵉ classe. En cas de gêne, commencez par en parler à votre voisin ; si cela ne suffit pas, la mairie peut intervenir — 02 38 45 61 76 ou mairie@mezieres-lez-clery.fr — et la gendarmerie peut être appelée pour un trouble en cours."
  },
  {
    name: "rgpd_dpo_recia",
  ...
  },
  {
    ...
    // ⚠️ `certificat` seul attrapait tout : « certificat de radiation » (règle
    // `inscription_scolaire`, placée plus bas) et « certificat médical » pour
    // une absence de classe (règle `ecole_absence_sante`) recevaient une réponse
    // sur les actes d'état civil. L'ordre du tableau étant la priorité, la seule
    // correction sûre est de restreindre `certificat` ici plutôt que de remonter
    // les règles scolaires au-dessus des démarches d'état civil.
    test: (q) => /(acte.naissance|acte.mariage|acte.deces|état civil|etat civil|extrait)/.test(q)
      || (/certificat/.test(q) && !/(medical|radiation|scolarit|scolaire|ecole|absence|maladie|vaccin|inscription)/.test(q)),
  ...
  },
  {
    ...
    answer: "🎒 Inscription scolaire à Mézières-lez-Cléry : elle se fait d'abord en mairie (02 38 45 61 76), qui délivre le certificat d'inscription, puis auprès de la direction de l'école de la Forêt pour l'admission — 36 rue du Bourg, 02 38 45 65 00. Pièces à apporter : livret de famille, justificatif de domicile de moins de 3 mois, carnet de santé à jour des vaccinations et, si l'enfant change d'établissement, le certificat de radiation de l'école précédente. Le restaurant scolaire et l'accueil périscolaire font l'objet d'une inscription distincte, entièrement dématérialisée sur le portail parents https://parents.logiciel-enfance.fr/mezieres-lez-clery — un seul dossier vaut pour tous les services périscolaires, avec la copie des vaccins et une attestation d'assurance mentionnant explicitement la responsabilité civile et l'individuelle accident."
  },
  {
    ...
    answer: "📦 Bienvenue à Mézières-lez-Cléry ! Les démarches à prévoir en arrivant : 1) passer vous présenter en mairie — 02 38 45 61 76, lundi 14h-17h30, mercredi sur rendez-vous, vendredi 8h30-11h30 ; 2) déclarer votre changement d'adresse via le téléservice https://www.service-public.gouv.fr/particuliers/vosdroits/R11193 ; 3) faire mettre en service vos compteurs d'eau, d'électricité et de gaz ; 4) demander vos bacs gris et jaune et vous inscrire à la déchetterie sur https://portail-usagers.ccterresduvaldeloire.fr ; 5) vous inscrire sur les listes électorales ; 6) inscrire vos enfants à l'école de la Forêt, au restaurant scolaire et au périscolaire ; 7) vérifier si votre adresse est raccordable à la fibre sur le réseau public Lysséo — https://lysseo.fr — puis souscrire auprès de l'opérateur commercial de votre choix, Lysséo ne vendant pas d'abonnement — l'application Mézières Avec Toi reprend cette liste complète et cochable dans sa page « Je viens d'emménager »."
  },
  // ─── École de la Forêt & services périscolaires ────────────
  // Source : règlement intérieur scolaire et périscolaire 2026-2027 de l'école
  // de la Forêt, remis par la mairie en septembre 2026.
  // ⛔ Aucun nom de personnel (enseignante, directrice, animateur, ATSEM,
  // cuisinier) n'est repris ici : ces personnes changent, et un nom faux est
  // pire qu'une fonction juste. On dit « la direction de l'école », « la
  // directrice du service périscolaire ». Verrouillé par test/ecole.test.js.
  // ⚠️ Ces règles sont placées AVANT `cantine` et `centre_loisirs`, dont les
  // motifs attrapent déjà `periscolaire`, `garderie` et `restaurant scolaire`.
  {
    // ⚠️ Le garde-fou `!medecin…` évite d'avaler « mon enfant est malade, quel
    // médecin consulter » : `maison_sante` est plus bas dans le tableau et ne
    // reprendrait jamais la main.
    name: "ecole_absence_sante",
    test: (q) => (
        // Termes qui ne peuvent désigner qu'une absence de classe, même sans
        // le mot « école » : « faut-il un certificat médical pour une absence »
        // n'en contient aucun, et repartait sur l'état civil.
        /(certificat medical|justificatif.{0,15}absence|absence.{0,15}justifi|demi.{0,4}journee|\bpai\b|protocole d accueil)/.test(q)
        || (/(absence|absent|absente|malade|maladie|medicament|traitement|asthme|poux|gastro|fievre|contagieu)/.test(q)
            && /(ecole|classe|scolaire|periscolaire|cantine|eleve|mon enfant|son enfant|les enfants)/.test(q))
      )
      && !/(medecin|docteur|generaliste|dentiste|kine|maison.{0,4}sante|pharmacie)/.test(q),
    answer: "🤒 Absence à l'école de la Forêt : prévenez la direction le jour même en précisant le motif — 02 38 45 65 00 (messagerie), ec-mezieres-lez-clery@ac-orleans-tours.fr ou le cahier de liaison. Les motifs réputés légitimes sont la maladie de l'enfant, une maladie contagieuse dans la famille, une réunion solennelle de famille, un empêchement accidentel de transport ou l'absence temporaire des responsables lorsque l'enfant les suit. À partir de quatre demi-journées non justifiées dans le mois, la direction saisit le DASEN ; une absence exceptionnelle prévue à l'avance demande une autorisation écrite à l'inspectrice de l'Éducation nationale de la circonscription. Un enfant malade reste chez lui, et l'école comme le périscolaire doivent être prévenus au plus tôt de tout risque d'épidémie ou d'infestation (gastro-entérite, poux…). Côté soins : aucun médicament n'est administré, ni à l'école ni au périscolaire, sauf dans le cadre d'un PAI ; seul le traitement contre l'asthme est admis, avec copie de l'ordonnance. Un enfant fiévreux au-delà de 38 °C ou contagieux n'est pas accepté aux activités périscolaires. Côté facturation du périscolaire, le premier jour d'absence reste dû : un écrit des parents suffit ensuite jusqu'à 3 jours, un certificat médical au-delà — enfance@mezieres-lez-clery.fr ou 09 67 28 01 20."
  },
  {
    name: "ecole_regles_vie",
    test: (q) => /(telephone portable|portable|smartphone|jeu electronique|jeux electroniques|objet.{0,12}(interdit|dangereux)|interdit.{0,12}(ecole|classe|cour)|tenue|vetement|habill|echarpe|foulard|bijou|bille|corde a sauter|bonbon|rentrer seul|rentre seul|repartir seul|\bvelo\b)/.test(q)
      && /(ecole|classe|cour|recreation|eleve|scolaire|maternelle|elementaire)/.test(q),
    answer: "🎒 Règles de vie à l'école de la Forêt : le téléphone portable et les jeux électroniques sont interdits — un appareil apporté est confisqué et remis aux parents dans un délai d'une semaine. Sont également prohibés les objets coupants, tranchants ou pointus (compas et ciseaux restent en classe), les briquets, allumettes et pétards, les gadgets à décharges électriques, ainsi que les bonbons. Les écharpes et foulards sont interdits pour éviter les risques d'étranglement : préférez un tour de cou. Les billes sont permises, mais uniquement dans la cour du bas ; cordes à sauter et élastiques sont admis sous réserve d'un usage correct ; il est interdit de jouer avec des bâtons, des cailloux ou des pierres, et de les lancer. Les tenues doivent être adaptées au temps, à l'âge et aux activités, en particulier les jours d'EPS : sont exclus les hauts trop courts ou décolletés, les shorts et jupes trop courts ou moulants et les pantalons déchirés. Un enfant autorisé à rentrer seul à vélo doit l'être par un écrit daté et signé remis à l'école, et votre assurance doit couvrir la responsabilité civile et l'individuelle accident, trajets à vélo compris. Renseignements : 02 38 45 65 00."
  },
  {
    // ⚠️ Le garde-fou `!alsh…` laisse la main à `centre_loisirs` sur « le centre
    // de loisirs pendant les vacances », qui n'est pas une question de dates.
    // ⚠️ Les dates sont datées de leur année scolaire, exprès : un calendrier
    // sans son millésime se lit comme celui de l'année en cours.
    name: "vacances_scolaires",
    test: (q) => /(vacances|conges)/.test(q)
      && /(scolaire|ecole|classe|date|calendrier|quand|toussaint|noel|hiver|printemps|ete|ascension|pentecote)/.test(q)
      && !/(alsh|centre.{0,4}loisirs|garderie|colonie)/.test(q),
    answer: "📅 Calendrier des vacances de l'année scolaire 2026-2027 pour l'école de la Forêt (zone B) : Toussaint, du samedi 17 octobre au lundi 2 novembre 2026 ; Noël, du samedi 19 décembre 2026 au lundi 4 janvier 2027 ; hiver, du samedi 20 février au lundi 8 mars 2027 ; printemps, du samedi 17 avril au lundi 3 mai 2027 ; pont de l'Ascension, du jeudi 6 au lundi 10 mai 2027 ; Pentecôte, le lundi 17 mai 2027 ; été, à partir du samedi 3 juillet 2027. Ces dates sont celles de l'année scolaire 2026-2027 uniquement — pour une autre année, consultez https://www.education.gouv.fr/calendrier-scolaire ou l'école au 02 38 45 65 00. Pendant les vacances, l'accueil de loisirs du Val d'Ardoux, organisé par la Communauté de Communes pour les 3-13 ans, prend le relais à Cléry-Saint-André et ponctuellement à Mézières — sauf aux vacances de Noël."
  },
  {
    // ⚠️ Placée AVANT `cantine` et `centre_loisirs`. Aucun tarif n'est écrit
    // ici : ils sont fixés chaque année par délibération du conseil municipal
    // et calculés sur le quotient familial CAF. Les recopier créerait une
    // double source vouée à diverger — même piège que la salle communale et la
    // crèche. `js/mat-mel.js` a affiché « Tarifs 2022/2023 » jusqu'en 2026.
    name: "periscolaire_services",
    test: (q) => /(periscolaire|garderie|accueil du matin|accueil du soir|accueil enchante|portail parents|logiciel enfance|gouter|mercredi.{0,20}(enfant|ecole|accueil|garde)|(enfant|ecole|accueil|garde).{0,20}mercredi)/.test(q),
    answer: "🌅 Les services périscolaires de Mézières-lez-Cléry — « L'Accueil enchanté », chemin des écoliers — sont gérés par la commune : 09 67 28 01 20 ou 06 32 43 97 75, enfance@mezieres-lez-clery.fr Horaires : accueil du matin de 7h30 à 8h20 en arrivée échelonnée, accueil du soir de 16h30 à 18h30 avec le goûter fourni, les lundi, mardi, jeudi et vendredi ; le mercredi, accueil de 7h30 à 18h00 en journée entière ou en demi-journée, avec ou sans repas. Tout passe par le portail parents https://parents.logiciel-enfance.fr/mezieres-lez-clery — dossier d'inscription unique pour tous les services (copie des vaccins, attestation d'assurance responsabilité civile et individuelle accident, jugement de divorce le cas échéant), réservations, annulations, mise à jour des personnes autorisées à venir chercher l'enfant et paiement par carte. Délais à retenir : 3 jours avant pour l'accueil du matin et du soir, le mardi de la semaine précédente pour le mercredi et la restauration ; passé ce délai, l'inscription se fait par mail et un surcoût est facturé. Au-delà de 18h30 en semaine et de 18h00 le mercredi, un retard est facturé par enfant, et les retards répétés conduisent à une exclusion. Les tarifs sont fixés chaque année par délibération du conseil municipal et calculés sur le quotient familial CAF au 1er août — la grille en vigueur est sur le portail parents ou auprès du service enfance."
  },
  {
    name: "cantine",
    test: (q) => /(cantine|restaurant scolaire|repas school|repas enfant|menu.{0,12}(ecole|scolaire|cantine))/.test(q),
    // ⚠️ Aucun montant : voir le commentaire de `periscolaire_services`.
    answer: "🍽️ Le restaurant scolaire de Mézières-lez-Cléry accueille les élèves de l'école de la Forêt les lundi, mardi, jeudi et vendredi, de 11h45 à 13h30. Les repas sont confectionnés sur place par un cuisinier communal, qui élabore les menus en veillant à l'équilibre nutritionnel et en privilégiant les circuits courts ; prévoyez une serviette de table dans une trousse marquée au nom de l'enfant. Seuls les enfants venus en classe le matin sont admis, et aucun départ ni retour n'est accepté entre 11h45 et 13h30. L'inscription et les réservations se font sur le portail parents https://parents.logiciel-enfance.fr/mezieres-lez-clery — au plus tard le mardi de la semaine précédente, sans quoi l'inscription passe par enfance@mezieres-lez-clery.fr avec un surcoût. En cas de régime alimentaire médical, un PAI doit être établi et réactualisé chaque rentrée ; la commune ne réalise pas de menu spécifique et s'en tient à la neutralité religieuse en matière de repas. Les tarifs, comme ceux du périscolaire, sont fixés chaque année par délibération du conseil municipal et calculés sur le quotient familial CAF au 1er août : la grille en vigueur est sur le portail parents ou auprès du service enfance — 09 67 28 01 20."
  },
  {
    // Règle générale sur l'école, placée APRÈS les règles précises pour qu'une
    // question sur une absence, la cantine ou le périscolaire garde la main.
    name: "ecole_horaires_contact",
    test: (q) => /(ecole|classe|maternelle|elementaire|primaire|\bapc\b|activites pedagogiques|cahier de liaison|conseil d ecole|coop|harcelement)/.test(q)
      && /(horaire|heure|ouvre|ouverture|ferme|fermeture|commence|termine|debut|fin|portail|adresse|telephone|contact|joindre|mail|courriel|jour|semaine|mercredi|foret|directrice|directeur|direction|reunion|liaison|apc|harcelement|coop)/.test(q),
    answer: "🏫 L'école de la Forêt est l'école primaire publique de Mézières-lez-Cléry, 36 rue du Bourg — 02 38 45 65 00, ec-mezieres-lez-clery@ac-orleans-tours.fr La semaine est de 4 jours : lundi, mardi, jeudi et vendredi, de 8h30 à 11h45 et de 13h45 à 16h30, soit 24 heures d'enseignement ; il n'y a pas de classe le mercredi. L'accueil des élèves est assuré dix minutes avant le début de la classe, à 8h20 et à 13h35, et le portail ferme à 8h30 et à 13h45 : merci de respecter ces horaires pour ne pas déranger la classe. Des activités pédagogiques complémentaires (APC) peuvent s'y ajouter pour les élèves de la GS au CM2, les lundis et jeudis sur le temps méridien, sur proposition des enseignantes et avec l'accord des parents. Le cahier de liaison est le canal de communication entre l'école et la famille — vérifiez-le et signez les mots. Votre premier interlocuteur est l'enseignante de votre enfant ; pour une question administrative, adressez-vous à la direction de l'école. Pour l'accueil périscolaire, le restaurant scolaire et le mercredi, c'est le service enfance de la commune : 09 67 28 01 20 — enfance@mezieres-lez-clery.fr"
  },
  {
    // ⚠️ Placée AVANT `centre_loisirs` : le LAEP n'est ni un accueil de loisirs
    // ni un mode de garde, et la confusion est facile. Il n'a AUCUN créneau à
    // Mézières — la commune la plus proche est Cléry-Saint-André. Les jours et
    // horaires de chaque commune ne sont pas repris ici : ils sont publiés par
    // la CCTVL et changeront sans que personne ici ne le sache. Ne jamais en
    // inventer (leçon des horaires de bruit, cf. test/bruit.test.js).
    name: "laep",
    test: (q) => /(\blaep\b|lieu.{0,6}accueil.{0,6}enfants?.{0,6}parents?|accueil.{0,4}enfants?.{0,4}parents?)/.test(q),
    answer: "👶 Le LAEP (Lieu d'Accueil Enfants-Parents) est un service itinérant de la Communauté de Communes des Terres du Val de Loire, ouvert à compter du 7 septembre 2026. Il accueille les enfants de moins de 6 ans accompagnés d'un parent, d'un grand-parent ou d'un adulte référent, ainsi que les futurs parents : un lieu convivial d'écoute, d'échanges, de jeux et de rencontres, qui favorise le lien parent-enfant et la socialisation des tout-petits. C'est gratuit, confidentiel et sans inscription. Ce n'est pas un mode de garde : l'adulte qui accompagne l'enfant reste avec lui pendant toute la durée de l'accueil. Au moins deux professionnels, appelés « accueillants », sont présents ; ils sont tenus au secret professionnel et à l'obligation de réserve. Le LAEP est itinérant et n'a pas de créneau à Mézières-lez-Cléry : il se déplace sur Beauce la Romaine, Beaugency, Cléry-Saint-André et Meung-sur-Loire — Cléry-Saint-André étant la plus proche de Mézières. Le planning des créneaux n'est pas encore publié. Renseignements au 06 62 65 59 04 ou par mail à laep@ccterresduvaldeloire.fr — la page du service est https://www.ccterresduvaldeloire.fr/laep-lieu-accueil-enfants-parents/ et la mairie répond au 02 38 45 61 76."
  },
  {
    // ⚠️ Placée AVANT `centre_loisirs`, dont le motif attrape déjà `creche` et
    // `marmousets` : sans cette règle, une question sur la crèche recevait une
    // réponse générique sur le périscolaire. Les chiffres viennent du règlement
    // de fonctionnement « parents » 2026-2027 du SIVU. Deux erreurs y ont été
    // corrigées, qui traînaient dans l'arbre de décision ET dans le corpus
    // « Le saviez-vous ? » : « 17 assistantes maternelles » (elles sont 16) et
    // « enfants de moins de 6 ans » — c'est de 10 semaines à l'entrée en
    // maternelle, les « moins de six ans » du règlement ne visant que les
    // places garanties de l'article D.214-7. Ne pas rétablir.
    // ⚠️ Aucun tarif ici : la participation suit le barème national CNAF, elle
    // dépend des revenus et du nombre d'enfants à charge de chaque famille.
    name: "creche",
    test: (q) => /(creche|marmousets|assistante?s? maternelle|mode de garde|faire garder mon enfant|garde d enfant)/.test(q),
    answer: "👶 La crèche familiale « Les Marmousets » est située 92 rue du Maréchal Foch à Cléry-Saint-André. Elle est gérée par un syndicat intercommunal (SIVU) qui regroupe Cléry-Saint-André, Mareau-aux-Prés et Mézières-lez-Cléry : les familles macériennes peuvent donc y prétendre — mais la crèche n'est pas située sur la commune. « Familiale » veut dire que les 16 assistantes maternelles salariées accueillent les enfants à leur domicile, avec des temps collectifs chaque semaine dans les locaux de la crèche ou en salle communale. Elle accueille les enfants de 10 semaines jusqu'à leur entrée à l'école maternelle ; les enfants déjà scolarisés peuvent l'être le mercredi et pendant les vacances, selon les places disponibles. Ouverture du lundi au vendredi, de 7h30 à 18h30. L'inscription se fait en liste d'attente, puis une commission d'attribution statue sur les places ; aucune condition d'activité professionnelle des parents n'est exigée, même si l'activité peut entrer dans les critères de priorité. La participation financière suit le barème national de la CNAF : elle dépend de vos revenus et du nombre d'enfants à charge. Renseignements au 02 38 45 76 56 ou à crechemarmousets@orange.fr."
  },
  {
    name: "centre_loisirs",
    ...
    answer: "🧒 Le centre de loisirs des vacances est l'accueil de loisirs sans hébergement (ALSH) du Val d'Ardoux, organisé par la Communauté de Communes des Terres du Val de Loire pour les enfants de 3 à 13 ans, il se tient à Cléry-Saint-André et ponctuellement à Mézières-lez-Cléry, et fonctionne à toutes les vacances sauf celles de Noël. Renseignements et dossier : accueilloisirs.ardoux@ccterresduvaldeloire.fr — CCTVL au 02 38 44 59 35. Pendant les périodes scolaires, la commune gère de son côté l'accueil périscolaire du matin et du soir, le restaurant scolaire et l'accueil du mercredi : 09 67 28 01 20 — enfance@mezieres-lez-clery.fr Pour la petite enfance, Mézières est commune partenaire de la crèche familiale Les Marmousets, située à Cléry-Saint-André : les familles macériennes peuvent y prétendre à ce titre. La Communauté de Communes propose par ailleurs un LAEP itinérant, gratuit et sans inscription, pour les moins de 6 ans accompagnés d'un adulte."
  },
  {
    name: "fibre",
    ...
    // abonnement — les « forfaits » visibles sur son site sont ceux des
    // opérateurs commerciaux présents sur le réseau. La formulation précédente
    // (« vérifiez votre éligibilité sur lysseo.fr ou contactez votre
    // fournisseur ») mettait les deux sur le même plan et sautait l'étape
    // préalable, qui est la seule bloquante pour une construction neuve.
    test: (q) => /fibre|eligibilit|raccordement.fibre|val.loire.fibre|lysseo|xpfibre|loiret.thd|raccordabl/.test(q),
    answer: "🌐 Lysséo est le réseau public fibre du Loiret : il construit et gère l'infrastructure en délégation de service public du Département, mais ne vend aucun abonnement — les offres sont celles des opérateurs commerciaux présents sur le réseau. 1) Construction neuve : votre adresse n'est pas automatiquement connue de l'opérateur d'infrastructure. Tant qu'elle n'y figure pas comme « raccordable », aucun opérateur ne peut enregistrer votre commande. Déclarez-la auprès de XpFibre / Loiret THD sur https://www.xpfibre.com/loiret-thd — ou via le site de Lysséo https://lysseo.fr — en joignant votre permis de construire, votre certificat de numérotation et un plan de masse localisant le regard et les fourreaux en limite de propriété. 2) Une fois l'adresse déclarée éligible, souscrivez auprès de l'opérateur de votre choix (Orange, SFR, Bouygues, Free…) : c'est son prestataire qui tire la fibre du point de branchement de la voirie jusqu'au logement, en empruntant vos fourreaux existants. Aucun génie civil supplémentaire n'est à prévoir, sous réserve que les fourreaux soient aiguillés et non obstrués — leur bon état relève du propriétaire sur la partie privative. 3) La mairie (02 38 45 61 76) vérifie de son côté que la numérotation de votre parcelle a bien été transmise et intégrée à la Base Adresse Nationale, condition nécessaire à la prise en compte par l'opérateur d'infrastructure."
  },
  {
  ...
  {
    // Placée APRÈS `cantine` et `centre_loisirs` : une question sur le
    // restaurant scolaire garde la main. Deux portes d'entrée : le nom de la
    // salle sous n'importe quelle forme, ou une intention de louer/réserver
    // CROISÉE avec un objet louable — sans le croisement, « tarif de la
    // concession au cimetière » partirait ici.
    // ⚠️ Aucun tarif n'est écrit ici : les prix vivent dans l'arbre de décision
    // (`app-mezieres/data/mel-tree.json`), que la mairie édite depuis l'admin
    // sans passer par le code. Les recopier créerait une double source vouée à
    // diverger — même piège que les associations et la fibre.
    name: "location_salle_materiel",
    test: (q) => /salle.{0,8}(fete|communale|polyvalente|municipale|village|associations)/.test(q)
      || (/(louer|loue|louons|louez|location|reserv|tarif|prix|cout|disponibilit)/.test(q)
          && /(\bsalle|barnum|\btable|chaise|materiel.{0,4}communal|materiel.{0,4}de.{0,4}la.{0,4}commune|materiel.{0,4}municipal)/.test(q)),
    answer: "🏛️ La salle communale (ou salle des fêtes) n'est plus proposée à la location : ni pour une fête de famille, ni pour un événement privé. Il n'y a donc ni tarif ni calendrier de réservation à consulter, quelle que soit la date. En revanche, la commune met du matériel à disposition des Macériens pour leurs manifestations : tables, chaises et barnums (deux tailles). Un chèque de caution est demandé et vous est restitué en fin de location si aucune dégradation n'est constatée. Les tarifs et les modalités exactes sont donnés par la mairie — 02 38 45 61 76 ou mairie@mezieres-lez-clery.fr — et détaillés dans la rubrique « Location de matériel » de mon arbre de décision. Pour un usage associatif ou communal de la salle, adressez-vous directement à la mairie."
  },
...
📞 02 38 45 61 76 | ✉️ urbanisme@mezieres-lez-clery.fr"
  },
  {
    ...
    // ⚠️ « déposer » accentué était du code mort : normalizeQuestion dé-accentue
    // la question avant le test (voir CLAUDE.md). Seul « deposer » peut matcher.
    //
    // « cerfa » et « formulaire » ajoutés le 27 août 2026 : « où trouver le
    // cerfa pour ma clôture ? » ne tombait sur AUCUNE règle — les règles
    // clôture exigent un second terme (rue, voisin, hauteur) — et partait donc
    // au modèle, sans garde-fou sur le numéro du formulaire. « formulaire »
    // seul étant trop large, il exige un terme d'urbanisme ; les démarches
    // d'état civil (PACS, CNI, élections) gardent la main de toute façon,
    // leurs règles étant placées bien avant celle-ci.
    test: (q) => /deposer|dossier|comment.faire.un.permis|comment.obtenir.un.permis|permis.de.construire|pc |gnau|guichet.numerique|cerfa/.test(q)
      || (/formulaire/.test(q) && /(cloture|abri|jardin|extension|veranda|piscine|permis|declaration prealable|urbanisme|travaux|terrasse|toiture|facade|ravalement)/.test(q)),
    answer: "🏗️ Pour déposer un permis de construire ou une déclaration préalable à Mézières-lez-Cléry : 1) Téléchargez le cerfa sur https://www.service-public.gouv.fr/particuliers/vosdroits/R2028 — déclaration préalable de constructions et travaux (clôture, abri de jardin, extension) = n°16702 ; déclaration préalable d’aménagements (lotissement, division de terrain) = n°16703 ; permis de construire = n°13406. 2) Si surface > 150 m² : architecte obligatoire. 3) Déposez en mairie (02 38 45 61 76) ou via le GNAU (guichet numérique) sur le site de la CCTVL. Délais : 1 mois pour DP, 2 mois pour PC. Validité : 3 ans. Pensez à afficher l'arrêté sur le terrain et à déclarer début (DOC) et achèvement (DAACT) des travaux.\
\
⚠️ Ces informations sont indicatives — vérifiez impérativement votre projet auprès de la mairie avant tout dépôt de dossier.\
📞 02 38 45 61 76 | ✉️ urbanisme@mezieres-lez-clery.fr"
  },
...
function buildCategoryPrompt(category, extraCtx) {
  const blocks = {
    ...
    enfance: `Tu réponds à une question sur les services à l'enfance de Mézières-lez-Cléry (école La Forêt, cantine, centre de loisirs, service périscolaire). ATTENTION : la crèche familiale Les Marmousets n'est PAS située à Mézières — elle est à Cléry-Saint-André, dont Mézières est commune partenaire. Ne dis jamais que la commune dispose d'une crèche, ni qu'elle accueille « de 0 à 6 ans » : c'est de 10 semaines à l'entrée en maternelle — voir le bloc CRÈCHE. Le LAEP (Lieu d'Accueil Enfants-Parents) de la Communauté de Communes n'est ni un mode de garde ni un service communal : il est itinérant, gratuit et sans inscription, et ne passe pas par Mézières — voir le bloc LAEP. Appuie-toi en priorité sur le contexte documentaire fourni. Si les horaires ou tarifs exacts ne sont pas dans le contexte, oriente vers la mairie (02 38 45 61 76).`,
    ...
    numerique: `Tu réponds à une question sur la connectivité numérique à Mézières-lez-Cléry. Le réseau fibre du département est Lysséo : réseau PUBLIC, construit et exploité par Loiret THD / Loiret Fibre (groupe XpFibre) en délégation de service public du Département du Loiret. C'est un opérateur d'INFRASTRUCTURE : il ne vend AUCUN abonnement, l'habitant souscrit auprès d'un opérateur commercial (Orange, SFR, Bouygues, Free…). Pour une construction neuve, l'adresse doit d'abord être déclarée auprès de l'opérateur d'infrastructure pour devenir « raccordable » — sans cela aucun opérateur ne peut enregistrer la commande. Ne promets pas de délais de déploiement que tu ne connais pas.`,
