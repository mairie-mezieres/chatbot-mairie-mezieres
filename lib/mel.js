...
const DIRECT_RULES = [
  ...
  },
  {
    ...
    answer: "💧 Eau, électricité et gaz : contactez les fournisseurs avant votre emménagement pour la mise en service des compteurs — comptez quelques jours de délai. Relevez les index le jour de votre arrivée et conservez-les. L'eau potable et l'assainissement collectif sont gérés par la Communauté de communes des Terres du Val de Loire (02 38 44 59 35). L'électricité et le gaz se souscrivent auprès du fournisseur de votre choix. Si votre logement n'est pas raccordé au tout-à-l'égout, c'est le SPANC qui suit votre installation."
  },
  {
  ...
  },
  {
    ...
    // est située dans un village voisin. La formulation précédente affirmait
    ...
    answer: "🧒 La commune dispose d'un centre de loisirs et d'un service périscolaire (garderie matin/soir). Pour la petite enfance, Mézières est partenaire de la crèche familiale Les Marmousets, située dans une commune voisine : les familles macériennes peuvent y prétendre à ce titre. Pour les inscriptions et tarifs, contactez la mairie (02 38 45 61 76) ou consultez mezieres-lez-clery.fr, rubrique Services à l'enfance."
  },
  {
    name: "fibre",
