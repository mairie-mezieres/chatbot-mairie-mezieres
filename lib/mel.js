...
const KEYWORDS = {
  ...
  scolaire:       ["école","ecole","cantine","restaurant scolaire","périscolaire","enfant","crèche","loisirs","garderie","marmousets","centre de loisirs","service à l'enfance","service à l'enfance","laep","enfants parents","accueillant"],
...
const DIRECT_RULES = [
  ...
  },
  {
    ...
    answer: "🧒 La commune dispose d'un centre de loisirs et d'un service périscolaire (garderie matin/soir). Pour la petite enfance, Mézières est commune partenaire de la crèche familiale Les Marmousets, située à Cléry-Saint-André : les familles macériennes peuvent y prétendre à ce titre. Pour les inscriptions et tarifs, contactez la mairie (02 38 45 61 76 — mairie@mezieres-lez-clery.fr). La Communauté de Communes propose par ailleurs un LAEP itinérant, gratuit et sans inscription, pour les moins de 6 ans accompagnés d'un adulte."
  },
  {
    name: "fibre",
