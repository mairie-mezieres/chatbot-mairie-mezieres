...
📞 02 38 45 61 76 | ✉️ urbanisme@mezieres-lez-clery.fr"
  ...
  {
    name: "bruit_voisinage_horaires",
    test: (q) =>
      /(tondeuse|tronconneuse|perceuse|raboteuse|scie|bricolag|jardinage|jardiner|bricoler).{0,50}(heure|horaire|quand|autoris|interdit|droit|peut|matin|soir|week.?end|samedi|dimanche|ferie)/.test(q) ||
      /(heure|horaire|quand|autoris|interdit|droit).{0,50}(tondeuse|tronconneuse|perceuse|bricolage|jardinage|bruit.{0,20}voisin)/.test(q) ||
      /(bruit|nuisance|tapage|tapageur).{0,40}(heure|horaire|quand|autoris|interdit|droit|voisin)/.test(q) ||
      /(heure|horaire|quand|droit).{0,40}(bruit|sonore|nuisance|tapage)/.test(q) ||
      /tranquillite.{0,30}(voisin|publique|horaire)|arrete.{0,20}(bruit|municipal|sonore)/.test(q),
    answer: "🔇 À Mézières-lez-Cléry, les travaux de bricolage ou de jardinage bruyants (tondeuse à moteur thermique, tronçonneuse, perceuse, raboteuse, scie mécanique…) sont autorisés :\n• Jours ouvrables : 8h30–12h00 et 14h30–19h30\n• Samedis : 9h00–12h00 et 15h00–19h00\n• Dimanches et jours fériés : 10h00–12h00\n\nEn dehors de ces plages, les bruits excessifs perturbant le voisinage sont interdits. En cas de non-respect, vous pouvez le signaler à la mairie : 02 38 45 61 76 ou mairie@mezieres-lez-clery.fr"
  }
];
