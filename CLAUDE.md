...
| **Atelier fichiers** (onglet 📎 de l'admin) — ⛔ **aucune route, aucune clé Redis, aucun log** : tout se calcule dans le navigateur. Ne pas lui inventer de contrepartie backend, c'est précisément ce qu'on évite | `GUIDE-ADMIN.md` §3bis puis `app-mezieres/docs/adr/0035-atelier-fichiers-les-documents-de-la-mairie-ne-sortent-pas-du-navigateur.md` |
